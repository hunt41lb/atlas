// @/src/lib/panw-parser/network/routing-profiles/bfd.ts
//
...
//
// XML path: <network><routing-profile><bfd><entry name="...">
// (VR BFD profiles are at <network><profiles><bfd-profile> — different!)
