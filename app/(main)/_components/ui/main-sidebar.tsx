    ...
    },
    {
      ...
      items: [
        { title: "Setup",
          ...
          groupOnly: true,
          items: [
            { title: "Management",    url: "/device/setup-management" },
            { title: "Operations",    url: "/device/setup-operations" },
            { title: "Services",      url: "/device/setup-services" },
            { title: "Interfaces",    url: "/device/setup-interfaces" },
            { title: "Content-ID",    url: "/device/setup-content-id" },
            { title: "WildFire",      url: "/device/setup-wildfire" },
            { title: "Session",       url: "/device/setup-session" },
            { title: "HSM",           url: "/device/setup-hsm" },
            { title: "ACE",           url: "/device/setup-ace" },
            { title: "Quantum",       url: "/device/setup-quantum" },
            { title: "PAN-OS Security", url: "/device/setup-pan-os-security" },
          ],
        },
