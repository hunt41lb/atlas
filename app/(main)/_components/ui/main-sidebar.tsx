  ...
  sidebarViews: [
    {
      ...
      items: [
        ...
        },
        {
	      ...
	      {
          title: "IPSec Tunnels",
          url: "/network/ipsec-tunnels",
        },
	      {
          title: "GRE Tunnels",
          url: "/network/gre-tunnels",
        },
        {
          title: "DHCP",
          url: "/network/dhcp",
        ...
        {
          title: "SD-WAN Interface",
          url: "/network/sd-wan-interface",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: "/objects/dynamic-user-groups",
        },
        {
          title: "Applications",
        ...
        {
          title: "GlobalProtect",
          url: "/objects/global-protect",
        },
        {
          title: "Host Compliance",
          url: "/objects/host-compliance",
        },
        {
          title: "External Dynamic Lists",
          url: "/objects/external-dynamic-lists",
        },
        {
          title: "Custom Objects",
          url: "/objects/custom-objects",
        },
        {
          title: "Security Profiles",
          url: "/objects/security-profiles",
        },
        {
        ...
        },
        {
          ...
          url: "/objects/log-forwarding",
        },
        {
          title: "Authentication",
          url: "/objects/authentication",
        },
        {
          title: "Decryption",
          url: "/objects/decryption",
        },
        {
          title: "SD-WAN Link Management",
          url: "/objects/sd-wan-link-management",
        },
        {
          title: "Schedules",
          url: "/objects/schedules",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: "/policies/policy-based-forwarding",
        },
        {
          title: "Decryption",
          url: "/policies/decryption",
        },
        {
          title: "Tunnel Inspection",
          url: "/policies/tunnel-inspection",
        },
        {
          title: "Application Override",
          url: "/policies/application-override",
        },
        {
          title: "Authentication",
          url: "/policies/authentication",
        },
        {
          title: "DoS Protection",
          url: "/policies/dos-protection",
        },
        {
          title: "SD-WAN",
          url: "/policies/sd-wan",
...
export function MainSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  return (
    <Sidebar variant="inset" {...props}>
      ...
      <SidebarContent>
        <SidebarViews items={data.sidebarViews} />
        <SidebarConfigurations projects={data.sidebarConfigurations} />
