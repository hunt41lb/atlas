...
export function LldpDialog({
  ...
  return (
    <DetailDialog title="LLDP Profile" open={open} onOpenChange={onOpenChange} maxWidth="sm:max-w-xl">
      <div className="space-y-4">
        <DisplayField label="Name" value={profile.name} />
        <DisplayField label="Mode" value="transmit-receive" />
        ...
        <Fieldset>
          <FieldsetLegend>Optional TLVs</FieldsetLegend>
          <FieldsetContent>
            ...
            <Fieldset disabled={!profile.managementAddressEnabled}>
              <FieldsetLegend>
