// @/app/(main)/network/_components/routing-profiles/filters/route-maps-bgp/route-maps-bgp-dialog.tsx
...
export function BgpRouteMapDialog({
  ...
  return (
    <>
      <DetailDialog title="Filters Route Maps BGP" open={open} onOpenChange={onOpenChange} maxWidth="sm:max-w-2xl">
